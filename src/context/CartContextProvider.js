...
const cartReducer = (state, action) => {
    console.log(state)
    switch (action.type) {
        case "ADD_ITEM":   //to selectedItems find kon va agar in id product nabud, push kon be selectedItems
        ...
        case "REMOVE_ITEM":  //satle zobale: products ro bargardun ke id ona ba id in product ke click shode, barabar nabashe, yani in product hazf mishe
